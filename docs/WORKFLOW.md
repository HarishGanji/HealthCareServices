...
- Healthcare service is integrated with a Feign client to call notification-service (`notification.service.url`).
- Trigger points currently include online prescription request creation and online prescription issuance.
- Detailed rollout plan is available in `docs/NOTIFICATION_MICROSERVICE_PLAN.md`.
